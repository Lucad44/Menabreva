...
const Accommodation = () => {
  ...
  return (
    <motion.div
      className={styles['stripe-accommodation']}
      initial={{ width: 0 }}
      animate={{ width: '100%' }}
      ...
      <section className={styles['hero-section']}>
        ...
        <div className={styles['hero-content']}>
          ...
          <p className={styles['hero-subtitle']}>
            Vivi il kitesurf al massimo con il nostro alloggio direttamente sul
            lago. Comfort, convenienza e community in un unico posto.
          </p>
        </div>
      </section>
        ...
        <div className={styles['services-container']}>
          <div className={styles['section-header']}>
            ...
            <p className={styles['section-description']}>
              Dai comfort dell'alloggio alla cucina di qualità, ogni dettaglio è
          ...
          <div className={styles['services-grid']}>
            <div className={styles['service-card']}>
              ...
              <p className={styles['service-description']}>
                ...
                accoglienti. Letti comodi, spazi comuni per socializzare e tutto
                quello che ti serve per sentirti a casa.
              </p>
            </div>
          ...
          <div className={styles['features-grid']}>
            <div className={styles['feature-card']}>
              ...
              <p className={styles['feature-description']}>
                Parcheggio privato direttamente di fronte alla struttura. Comodo
                e sicuro per tutta la durata del soggiorno.
              </p>
            </div>
            ...
            <div className={styles['feature-card']}>
              ...
              <p className={styles['feature-description']}>
                Stanze accoglienti con letti comodi, perfette per recuperare le
                energie dopo le sessioni in acqua.
              </p>
            </div>
            ...
            <div className={styles['feature-card']}>
              ...
              <p className={styles['feature-description']}>
                Possibilità di preparare i propri pasti o gustare le specialità
